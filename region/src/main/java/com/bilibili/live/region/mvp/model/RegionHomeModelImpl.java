...
public class RegionHomeModelImpl implements IRegionHomeModel{
    ...
    public RegionHomeModelImpl(IRegionHomeModel.RegionHomeDataCallBackListener callBackListener) {
