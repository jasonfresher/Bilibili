...
public class MediaController extends FrameLayout {
    ...
    private TextView mEndTime,mTimeLine,mCurrentTime;
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            String time = TimeFormatUtils.generateTime(newposition);
            if (mInstantSeeking) {
    ...
    private void initControllerView(View v) {
        ...
        mTimeLine = (TextView) v.findViewById(R.id.time_line);
        ...
        View controlView = findViewById(R.id.media_controller_controls);
        ...
        View controlHeaderView = findViewById(R.id.media_controller_header);
        controlHeaderView.setOnTouchListener(new OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                mHandler.removeMessages(FADE_OUT);
                mHandler.sendMessageDelayed(mHandler.obtainMessage(FADE_OUT), sDefaultTimeout);
...
//            }
    ...
    private long setProgress() {
        ...
        if (mEndTime != null) {
            mEndTime.setText(TimeFormatUtils.generateTime(mDuration));
        }
        if (mCurrentTime != null) {
            mCurrentTime.setText(TimeFormatUtils.generateTime(position));
        }
...
//    }
    ...
    public void enableLiveUI(){
        if(mTimeLine != null && mProgress != null && mEndTime != null){
