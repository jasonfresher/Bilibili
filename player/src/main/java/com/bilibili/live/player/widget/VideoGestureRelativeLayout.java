...
public class VideoGestureRelativeLayout extends RelativeLayout {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (hasFF_REW) {
                        if(mPlayerView != null){
                            //手指抬起进行seekTo
                            long seekToMsec = (long)(mPlayerView.getDuration() * (newProgress * 1.0f / 1000));
                            mPlayerView.seekTo(seekToMsec);
                            //seekTo结束之后mediaController3秒后消失
                            mPlayerView.showMediaControls(3000);
    ...
    public void attachMediaPlayer(VideoPlayerView videoPlayerView) {
        mPlayerView = videoPlayerView;
    }
    ...
    public class VideoPlayerOnGestureListener extends GestureDetector.SimpleOnGestureListener{
            ...
            switch (mScrollMode) {
                ...
                case FF_REW:
                    if(mPlayerView != null){
                        ...
                        mPlayerView.showMediaControls(0);
                        //根据移动的正负决定快进还是快退
                        ...
                        long seekPosition = (mPlayerView.getDuration() * newProgress) / 1000;
        ...
        public boolean onDown(MotionEvent e) {
            ...
            if(mPlayerView != null){
                ...
                mPlayerView.toggleMediaControl();
            }else if (mGestureCallback != null) {
